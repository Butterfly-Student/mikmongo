...
- **Global scope**: `/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/notes/`)
...
2. Glob `/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/notes/` — works in any directory

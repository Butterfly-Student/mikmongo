...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks /home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/get-shit-done
                  → writes to /home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/butterfly-student/Programing/Mikrotik/mikmongo-fully/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

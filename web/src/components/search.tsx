  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'sm:h-8 max-sm:size-8 max-sm:justify-center max-sm:p-0',
        className
      )}
    ...
    >
      <SearchIcon
        aria-hidden='true'
        className='absolute start-2 top-1/2 -translate-y-1/2 hidden sm:block md:start-1.5'
        size={16}
      />
      <SearchIcon
        aria-hidden='true'
        ...
        size={16}
      />
      <span className='hidden ms-4 sm:block'>{placeholder}</span>

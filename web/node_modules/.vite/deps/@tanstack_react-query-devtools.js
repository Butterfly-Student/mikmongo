...
import { C as useQueryClient, z as onlineManager } from "./modern-CknJsN93.js";
import { G as setupStyleSheet, I as mergeProps, P as lazy, V as render, m as createComponent, x as createSignal } from "./EO4IN5ML-LbC8AeCo.js";
//#region node_modules/.pnpm/@tanstack+query-devtools@5.95.2/node_modules/@tanstack/query-devtools/build/dev.js
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./XMTSMVTM-skpnCkzn.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./AY2UQYZQ-DxzNUZSm.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devtools@5.95.2_@tanstack+react-query@5.95.2_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtools.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devtools@5.95.2_@tanstack+react-query@5.95.2_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtoolsPanel.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devtools@5.95.2_@tanstack+react-query@5.95.2_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-query-devtools/build/modern/index.js

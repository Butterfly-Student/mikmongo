...
//#region node_modules/.pnpm/react-top-loading-bar@3.0.2_react@19.2.4/node_modules/react-top-loading-bar/dist/index.mjs
...
function Y(e, t, m) {
	...
	(0, import_react.useEffect)(() => {
		a.current = e;
	}), (0, import_react.useEffect)(() => {}, [m]), (0, import_react.useEffect)(() => {
...
var Q = (0, import_react.forwardRef)(({ progress: e, height: t = 2, className: m = "", color: a = "red", background: d = "transparent", onLoaderFinished: b, transitionTime: n = 300, loaderSpeed: i = 500, waitingTime: N = 1e3, shadow: y = !0, containerStyle: T = {}, style: E = {}, shadowStyle: O = {}, containerClassName: z = "" }, C) => {
	let S = (0, import_react.useRef)(!1), [p, c] = (0, import_react.useState)(0), f = (0, import_react.useRef)({
		active: !1,
		refreshRate: 1e3
		...
		left: "-10rem"
	}, [g, P] = (0, import_react.useState)(F), [w, L] = (0, import_react.useState)(j);
	(0, import_react.useEffect)(() => (S.current = !0, () => {
		S.current = !1;
	...
	return Y(() => {
		let s = k(Math.min(10, (100 - p) / 5), Math.min(20, (100 - p) / 3));
		p + s < 95 && (c(p + s), u(p + s));
	}, f.current.active ? f.current.refreshRate : null), import_react.createElement("div", {
		className: z,
		style: {
			...H,
			...T
	...
	}, y ? import_react.createElement("div", { style: {
		...w,
		...O
	} }) : null));
}), M = import_react.createContext(void 0), re = ({ children: e, props: t }) => {
	let [m, a] = (0, import_react.useState)(t || {}), d = (0, import_react.useRef)(null), b = (n = "continuous") => {
		var i;
		return (i = d.current) == null ? void 0 : i.start(n);
	};
	return import_react.createElement(M.Provider, { value: {
		start: b,
		complete: () => {
			var n;
	...
	let t = import_react.useContext(M);

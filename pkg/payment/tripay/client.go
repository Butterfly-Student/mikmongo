...
var ErrNotImplemented = errors.New("tripay: not yet implemented")

// Client is a stub implementation of gateway.Provider for Tripay.
// It returns ErrNotImplemented for all operations until fully implemented.
type Client struct{}

// New creates a stub Tripay client.
func New() *Client { return &Client{} }

// Name returns the gateway name.
func (c *Client) Name() string { return "tripay" }
